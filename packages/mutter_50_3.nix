...
stdenv.mkDerivation (finalAttrs: {
  ...
  mesonFlags = [
    ...
    "-Dtests=disabled" # For NVIDIA proprietary driver up to 470.
    # https://src.fedoraproject.org/rpms/mutter/pull-request/49
    "-Dwayland_eglstream=true"
    "-Dprofiler=true"
    "-Dxwayland_path=${lib.getExe xwayland}" # This should be auto detected, but it looks like it manages a false positive.
  ...
  buildInputs = [
    ...
    libxrandr
    libxinerama
    libxau # for gdctl and gnome-service-client shebangs
  ...
  passthru = {
    ...
    updateScript = gnome.updateScript { packageName = "mutter"; };
  };
